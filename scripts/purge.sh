...
libproc-processtable-perl libprojectm2 libprotobuf9 libqjson0 libqxt-core0 libqxt-gui0 libraw15 \
...
libwebkitgtk-1.0-0 libwmf0.2-7 bunsen-pepperflash papirus-gtk-icon-theme mediterranean-thce-themes \
mx-bluebird-themes mx-greybird-themes mx-sound-theme-borealis tango-icon-theme zukitwo-themes mx-system-sounds \
mx-apps mx-defaultlook mx-welcome
